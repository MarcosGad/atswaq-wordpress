									...
									<article class="entry clr">
										...
										<!-- ar --> 
											...
											<div class="error404-content clr">
													...
													<h2 class="error-title"><?php esc_html_e( 'لا يمكن العثور على هذه الصفحة!', 'oceanwp' ) ?></h2>
													<p class="error-text"><?php esc_html_e( 'نحن نأسف. لكن الصفحة التي تبحث عنها غير متوفرة.', 'oceanwp' ); ?><br /><?php esc_html_e( 'ربما يمكنك تجربة بحث جديد.', 'oceanwp' ); ?></p>

													<p class="i-404"><i>404</i></p>

													<a class="error-btn button" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e( 'العودة إلى الصفحة الرئيسية', 'oceanwp' ) ?></a>
